...
PlayBar::PlayBar(SceneApp* app,
                 ...
                 int group,
                 bool minified) : Canvas(app,
                                         MoMa::Canvas::Container,
                                         "Player",
                                         position,
                                         alignment,
                                         NULL,
...
const ofxGuiGroup* group_cast = container->set
  ...
  addLabel("   ");
  bt_prevFrame = addImageButton("|<", libPath + "GUI/bt_previousframe.png", false);
  timeinput = addTextInput("time", "0.0", bt_prevFrame->getRect()->getWidth(), bt_prevFrame->getRect()->getHeight());
  bt_nextFrame = addImageButton(">|", libPath + "GUI/bt_nextframe.png", false);

  addLabel("   ");
  bt_prevSpeed = addImageButton("«", libPath + "GUI/bt_previousframe.png", false);
  speedinput = addTextInput("speed", to_string(app->playSpeed), bt_prevSpeed->getRect()->getWidth(), bt_prevSpeed->getRect()->getHeight());
  bt_nextSpeed = addImageButton("»", libPath + "GUI/bt_nextframe.png", false);
