...
void V3dParser::load(string const &fileName, Track *track)
{
    ...
    // Skip header ( 5 lines )
    if (v3dFile.good())
        getline(v3dFile, thisLine); // Aller a la ligne 1
    if (v3dFile.good())
        getline(v3dFile, thisLine); // Aller a la ligne 2
    if (v3dFile.good())
        getline(v3dFile, thisLine); // Aller a la ligne 3
    if (v3dFile.good())
        getline(v3dFile, thisLine); // Aller a la ligne 4
    if (v3dFile.good())
        getline(v3dFile, thisLine); // Aller a la ligne 5
    ...
    if (rawJoint[3] == rawJoint[2] && rawJoint[6] != rawJoint[2])
    {
