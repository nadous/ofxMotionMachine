...
arma::vec quaternion::getEuler(rotationOrder order) const
{
    ...
    if (order == EULER_XYZ)
        ret << a1 * 180 / M_PI << a2 * 180 / M_PI << a3 * 180 / M_PI;
    else if (order == EULER_YZX)
        ret << a3 * 180 / M_PI << a1 * 180 / M_PI << a2 * 180 / M_PI;
    else if (order == EULER_ZXY)
        ret << a2 * 180 / M_PI << a3 * 180 / M_PI << a1 * 180 / M_PI;
    else if (order == EULER_ZYX)
        ret << a3 * 180 / M_PI << a2 * 180 / M_PI << a1 * 180 / M_PI;
    else if (order == EULER_YXZ)
        ret << a2 * 180 / M_PI << a1 * 180 / M_PI << a3 * 180 / M_PI;
    else if (order == EULER_XZY)
        ret << a1 * 180 / M_PI << a3 * 180 / M_PI << a2 * 180 / M_PI;
    return ret;
}
