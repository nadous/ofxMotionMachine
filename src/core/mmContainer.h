...
namespace MoMa {
	...
	public:
		...
		inline unsigned int setBufferSize(unsigned int pBufferSize){mBufferSize=pBufferSize; return mBufferSize;};
      ...
      protected:
        ...
        bool setValidIntervalTime( double time ) { mInterpValidTime = time; return true;};
